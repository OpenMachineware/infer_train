...
def _embedding_cpu_kernel[
    ...
    var out = tensor_zeros[dtype, 2](StaticTuple[Int, 2](n_tokens, hidden))
...
def embedding_cpu_forward_with_saved[
    dtype: DType, hidden: Int, vocab: Int
