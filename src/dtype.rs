...
impl DType for bf16 {
    ...
    fn zero() -> Self { bf16::from_f32(0.0) }
    fn one() -> Self { bf16::from_f32(1.0) }
    fn dtype_name() -> &'static str { "bf16" }
}
...
impl DType for i8 {
    ...
    fn zero() -> Self { 0 }
    fn one() -> Self { 1 }
    fn dtype_name() -> &'static str { "i8" }
    fn is_quantized() -> bool { true }
}
